...
(function() {
 var loadPackage = function(metadata) {
    ...
    var PACKAGE_NAME = 'WebGL Unity Build.data';
    var REMOTE_PACKAGE_BASE = 'WebGL Unity Build.data';
    ...
    var REMOTE_PACKAGE_NAME = typeof Module['locateFile'] === 'function' ?
      ...
      var REMOTE_PACKAGE_SIZE = 2449225;
      var PACKAGE_UUID = '79992184-c1df-4a10-b309-49fcdbf6619c';
...
Module['FS_createPath']('/Managed/mono', '2.0', true, true);
    ...
    DataRequest.prototype = {
      ...
      new DataRequest(0, 129202, 0, 0).open('GET', '/data.unity3d');
    new DataRequest(129202, 129223, 0, 0).open('GET', '/methods_pointedto_by_uievents.xml');
    new DataRequest(129223, 129244, 0, 0).open('GET', '/preserved_derived_types.xml');
    new DataRequest(129244, 1546628, 0, 0).open('GET', '/Il2CppData/Metadata/global-metadata.dat');
    new DataRequest(1546628, 2421600, 0, 0).open('GET', '/Resources/unity_default_resources');
    new DataRequest(2421600, 2449225, 0, 0).open('GET', '/Managed/mono/2.0/machine.config');
    ...
    function processPackageData(arrayBuffer) {
      ...
      DataRequest.prototype.byteArray = byteArray;
          ...
          Module['removeRunDependency']('datafile_WebGL Unity Build.data');

    };
    Module['addRunDependency']('datafile_WebGL Unity Build.data');
